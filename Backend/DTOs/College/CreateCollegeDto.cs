...
{
    public class CreateCollegeDto : IValidatableObject
    {
        [StringLength(50)]
        ...
        public string? EffectiveLogoPath
        {
            get
            {
                ...
                // The frontend sends a base64 preview. It cannot be stored in
                // the 500-character logo-path column.
        ...
        {
            if (string.IsNullOrWhiteSpace(EffectiveCollegeCode))
                yield return new ValidationResult(
                    "College code is required.",
                    new[] { nameof(CollegeCode) });
