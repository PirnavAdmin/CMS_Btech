...
const demoRequestUrl = `${import.meta.env.DEV ? '' : (import.meta.env.VITE_API_BASE_URL || 'https://movable-swampland-tinderbox.ngrok-free.dev').trim().replace(/\/+$/, '')}/api/v1/demo-requests`
