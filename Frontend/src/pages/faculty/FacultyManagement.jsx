...
function validateFaculty(data, rows) {
  ...
  if (!data.employeeId || rows.some(row => row.id !== data.id && (row.employeeId || row.facultyCode) === data.employeeId)) errors.employeeId = 'Faculty ID must be unique.'
