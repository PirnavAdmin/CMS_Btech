...
export default function LandingPage(){const [demoOpen,setDemoOpen]=useState(false);return <main className="lp-page"><nav className="lp-nav"><div><Brand/><div className="lp-links"><a href="#home">Home</a><a href="#about">About</a><a href="#academics">Academics</a><a href="#campus">Campus</a><a href="#platform">Platform</a><a href="#services">Services</a></div><div className="lp-actions"><a href="#campus">Explore Campus</a><ThemeToggle/><Link className="lp-button small" to="/login">Login <FiArrowRight/></Link></div><details><summary aria-label="Open navigation"><FiMenu/></summary><div><a href="#academics">Academics</a><a href="#campus">Campus</a><a href="#platform">Platform</a><a href="#services">Services</a><a href="#about">About</a></div></details></div></nav>
<section className="lp-hero universal" id="home"><div className="lp-hero-content"><p className="lp-eyebrow">A connected digital campus</p><h1>One campus.<span>One connected academic experience.</span></h1><p className="lp-lead">A unified digital platform bringing academic information, campus services, communication and institutional operations together for a modern B.Tech college.</p><div className="lp-hero-actions"><button type="button" className="lp-button" onClick={()=>setDemoOpen(true)}>Request Demo <FiArrowRight/></button><a className="lp-button outline" href="#academics">Explore Digital Campus</a></div><div className="lp-trust">{['Connected Academics','Campus Information','Essential Services','Secure Access'].map(x=><span key={x}><FiCheck/> {x}</span>)}</div></div></section>
...
</footer>{demoOpen&&<RequestDemo onClose={()=>setDemoOpen(false)}/>}</main>}
