...
export default function MyProfile() {
  ...
  return <DashboardLayout><main className="profile-page" data-export-record>
    <header className="profile-heading"><ExportMenu mode="single" title="My Profile" filename={`profile_${profile.identifier || profile.fullName}`} /><div><p className="profile-eyebrow">{isStudent ? 'Student dashboard' : 'Account'}</p><h1>My Profile</h1><p>{isStudent ? 'View your personal details and current academic information.' : 'Review your saved identity and account information.'}</p></div><button type="button" className="profile-button" onClick={openEdit}><FiEdit2 className="module-action-icon module-action-icon--edit" /> Edit Profile</button></header>
