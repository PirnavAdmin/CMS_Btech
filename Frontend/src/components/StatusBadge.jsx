...
const normalizeStatusKey = (value) => {
  ...
  if (['0', 'false', 'inactive', 'deactive', 'archived', 'ineligible', 'resigned', 'relieved', 'terminated', 'retired'].includes(str)) return 'inactive'
  if (['upcoming', 'probation', 'on-probation', 'notice-period', 'contract'].includes(str)) return 'upcoming'
  if (['completed', 'transferred'].includes(str)) return 'completed'
