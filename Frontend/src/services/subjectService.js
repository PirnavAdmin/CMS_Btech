...
const initialCreditStructure = {
  ...
  categories: [
    { code: 'BSC', name: 'Basic Science Courses', requiredCredits: 25, earnedRange: '24-26', color: '#0F172A' },
    { code: 'ESC', name: 'Engineering Science Courses', requiredCredits: 24, earnedRange: '22-26', color: '#0284c7' },
    { code: 'HSMC', name: 'Humanities, Social Sciences & Management', requiredCredits: 12, earnedRange: '10-14', color: '#10b981' },
    { code: 'PCC', name: 'Professional Core Courses', requiredCredits: 54, earnedRange: '50-58', color: '#0d9488' },
    { code: 'PEC', name: 'Professional Elective Courses', requiredCredits: 18, earnedRange: '15-21', color: '#0F172A' },
    { code: 'OEC', name: 'Open Elective Courses', requiredCredits: 12, earnedRange: '9-15', color: '#0891b2' },
    { code: 'PROJ', name: 'Project Work, Internship & Seminar', requiredCredits: 15, earnedRange: '14-16', color: '#0369a1' },
